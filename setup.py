...
setup(
  ...
  url = 'https://github.com/ShamyakGoel/cfunctions/',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/ShamyakGoel/cfunctions/archive/refs/tags/v_01.tar.gz',    # I explain this later on
